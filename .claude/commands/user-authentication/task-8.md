# user-authentication - Task 8

Execute task 8 for the user-authentication specification.
...
Execute with @spec-task-executor agent the following task: "创建领域错误类型"

```
Use the @spec-task-executor agent to implement task 8: "创建领域错误类型" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: 创建领域错误类型
- Requirements: 5.2

## Instructions
- Implement ONLY task 8: "创建领域错误类型"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 8 --mode complete
```
