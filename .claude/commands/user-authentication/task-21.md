# user-authentication - Task 21

Execute task 21 for the user-authentication specification.

## Task Description
创建 AuthService - 验证码校验逻辑
...
## Usage
```
/Task:21-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 AuthService - 验证码校验逻辑"

```
Use the @spec-task-executor agent to implement task 21: "创建 AuthService - 验证码校验逻辑" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: 创建 AuthService - 验证码校验逻辑
- Requirements: 2.2

## Instructions
- Implement ONLY task 21: "创建 AuthService - 验证码校验逻辑"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 21 --mode complete
```
