# user-authentication - Task 31

Execute task 31 for the user-authentication specification.
...
## Usage
```
/Task:31-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现用户类型选择端点"

```
Use the @spec-task-executor agent to implement task 31: "实现用户类型选择端点" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: 实现用户类型选择端点
- Requirements: 3.1, 3.2

## Instructions
- Implement ONLY task 31: "实现用户类型选择端点"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 31 --mode complete
```
