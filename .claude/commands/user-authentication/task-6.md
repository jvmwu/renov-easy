...
Execute with @spec-task-executor agent the following task: "创建 VerificationCode 实体模型"

```
Use the @spec-task-executor agent to implement task 6: "创建 VerificationCode 实体模型" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 创建 VerificationCode 实体模型
- Requirements: 2.1

## Instructions
- Implement ONLY task 6: "创建 VerificationCode 实体模型"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 6 --mode complete
```
