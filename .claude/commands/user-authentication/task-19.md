# user-authentication - Task 19

Execute task 19 for the user-authentication specification.
...
Execute with @spec-task-executor agent the following task: "创建 VerificationService"

```
Use the @spec-task-executor agent to implement task 19: "创建 VerificationService" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: 创建 VerificationService
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 19: "创建 VerificationService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 19 --mode complete
```
