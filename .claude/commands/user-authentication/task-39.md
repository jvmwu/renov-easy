# user-authentication - Task 39

Execute task 39 for the user-authentication specification.

## Task Description
创建 VerificationService 单元测试
...
## Usage
```
/Task:39-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 VerificationService 单元测试"

```
Use the @spec-task-executor agent to implement task 39: "创建 VerificationService 单元测试" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 39
- Description: 创建 VerificationService 单元测试
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 39: "创建 VerificationService 单元测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 39 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 39 --mode complete
```
