# user-authentication - Task 17

Execute task 17 for the user-authentication specification.

## Task Description
创建 SMS 服务接口和 Mock 实现
...
## Usage
```
/Task:17-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 SMS 服务接口和 Mock 实现"

```
Use the @spec-task-executor agent to implement task 17: "创建 SMS 服务接口和 Mock 实现" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: 创建 SMS 服务接口和 Mock 实现
- Requirements: 1.1, 2.1

## Instructions
- Implement ONLY task 17: "创建 SMS 服务接口和 Mock 实现"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 17 --mode complete
```
