# user-authentication - Task 20

Execute task 20 for the user-authentication specification.

## Task Description
创建 AuthService - 发送验证码功能
...
Execute with @spec-task-executor agent the following task: "创建 AuthService - 发送验证码功能"

```
Use the @spec-task-executor agent to implement task 20: "创建 AuthService - 发送验证码功能" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: 创建 AuthService - 发送验证码功能
- Requirements: 1.1, 5.1

## Instructions
- Implement ONLY task 20: "创建 AuthService - 发送验证码功能"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 20 --mode complete
```
