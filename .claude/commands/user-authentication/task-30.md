# user-authentication - Task 30

Execute task 30 for the user-authentication specification.
...
## Usage
```
/Task:30-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现验证码验证端点"

```
Use the @spec-task-executor agent to implement task 30: "实现验证码验证端点" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: 实现验证码验证端点
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 30: "实现验证码验证端点"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 30 --mode complete
```
