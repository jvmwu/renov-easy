# user-authentication - Task 33

Execute task 33 for the user-authentication specification.
...
## Usage
```
/Task:33-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现登出端点"

```
Use the @spec-task-executor agent to implement task 33: "实现登出端点" for the user-authentication specification and include all the below context.
...
## Instructions
- Implement ONLY task 33: "实现登出端点"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 33 --mode complete
```
