# user-authentication - Task 25

Execute task 25 for the user-authentication specification.
...
## Usage
```
/Task:25-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建速率限制中间件"

```
Use the @spec-task-executor agent to implement task 25: "创建速率限制中间件" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: 创建速率限制中间件
- Requirements: 5.1, 5.2

## Instructions
- Implement ONLY task 25: "创建速率限制中间件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 25 --mode complete
```
