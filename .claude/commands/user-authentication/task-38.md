# user-authentication - Task 38

Execute task 38 for the user-authentication specification.

## Task Description
创建 TokenService 单元测试
...
## Usage
```
/Task:38-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 TokenService 单元测试"

```
Use the @spec-task-executor agent to implement task 38: "创建 TokenService 单元测试" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: 创建 TokenService 单元测试
- Requirements: 4.1

## Instructions
- Implement ONLY task 38: "创建 TokenService 单元测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 38 --mode complete
```
