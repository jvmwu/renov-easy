...
## Task Description
创建 Rust workspace 配置文件 server/Cargo.toml
...
Execute with @spec-task-executor agent the following task: "创建 Rust workspace 配置文件 server/Cargo.toml"

```
Use the @spec-task-executor agent to implement task 1: "创建 Rust workspace 配置文件 server/Cargo.toml" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: 创建 Rust workspace 配置文件 server/Cargo.toml
- Requirements: 技术栈设置

## Instructions
- Implement ONLY task 1: "创建 Rust workspace 配置文件 server/Cargo.toml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 1 --mode complete
```
