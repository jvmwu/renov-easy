# user-authentication - Task 34

Execute task 34 for the user-authentication specification.
...
## Usage
```
/Task:34-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建统一错误处理器"

```
Use the @spec-task-executor agent to implement task 34: "创建统一错误处理器" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: 创建统一错误处理器
- Requirements: 错误处理设计

## Instructions
- Implement ONLY task 34: "创建统一错误处理器"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 34 --mode complete
```
