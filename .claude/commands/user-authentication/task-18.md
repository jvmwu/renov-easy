# user-authentication - Task 18

Execute task 18 for the user-authentication specification.
...
Execute with @spec-task-executor agent the following task: "创建 TokenService"

```
Use the @spec-task-executor agent to implement task 18: "创建 TokenService" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: 创建 TokenService
- Requirements: 4.1, 4.2, 4.3

## Instructions
- Implement ONLY task 18: "创建 TokenService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 18 --mode complete
```
