# user-authentication - Task 43

Execute task 43 for the user-authentication specification.
...
## Usage
```
/Task:43-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建项目 README 文档"

```
Use the @spec-task-executor agent to implement task 43: "创建项目 README 文档" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 43
- Description: 创建项目 README 文档
- Requirements: 文档要求

## Instructions
- Implement ONLY task 43: "创建项目 README 文档"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 43 --mode complete
```
