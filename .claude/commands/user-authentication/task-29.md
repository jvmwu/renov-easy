# user-authentication - Task 29

Execute task 29 for the user-authentication specification.
...
## Usage
```
/Task:29-user-authentication
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现发送验证码端点"

```
Use the @spec-task-executor agent to implement task 29: "实现发送验证码端点" for the user-authentication specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: 实现发送验证码端点
- Requirements: 1.1

## Instructions
- Implement ONLY task 29: "实现发送验证码端点"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-authentication 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-authentication 29 --mode complete
```
