# auth-passwordless - Task 21

Execute task 21 for the auth-passwordless specification.

## Task Description
集成审计日志到认证流程

## Code Reuse
**Leverage existing code**: AuditService, 现有 AuthService
...
## Usage
```
/Task:21-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "集成审计日志到认证流程"

```
Use the @spec-task-executor agent to implement task 21: "集成审计日志到认证流程" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: 集成审计日志到认证流程
- Leverage: AuditService, 现有 AuthService
- Requirements: 7.2, 7.3, 7.4

## Instructions
- Implement ONLY task 21: "集成审计日志到认证流程"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 21 --mode complete
```
