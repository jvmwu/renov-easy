# auth-passwordless - Task 4

Execute task 4 for the auth-passwordless specification.

## Task Description
实现 OTP 加密服务模块

## Code Reuse
**Leverage existing code**: 使用 aes-gcm crate
...
## Usage
```
/Task:4-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现 OTP 加密服务模块"

```
Use the @spec-task-executor agent to implement task 4: "实现 OTP 加密服务模块" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: 实现 OTP 加密服务模块
- Leverage: 使用 aes-gcm crate
- Requirements: 8.1, 8.2

## Instructions
- Implement ONLY task 4: "实现 OTP 加密服务模块"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 4 --mode complete
```
