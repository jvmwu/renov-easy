# auth-passwordless - Task 8

Execute task 8 for the auth-passwordless specification.

## Task Description
实现 AWS SNS SMS 服务提供商

## Code Reuse
**Leverage existing code**: server/core/src/services/verification/traits.rs
...
## Usage
```
/Task:8-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现 AWS SNS SMS 服务提供商"

```
Use the @spec-task-executor agent to implement task 8: "实现 AWS SNS SMS 服务提供商" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: 实现 AWS SNS SMS 服务提供商
- Leverage: server/core/src/services/verification/traits.rs
- Requirements: 2.10

## Instructions
- Implement ONLY task 8: "实现 AWS SNS SMS 服务提供商"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 8 --mode complete
```
