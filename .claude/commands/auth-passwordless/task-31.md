# auth-passwordless - Task 31

Execute task 31 for the auth-passwordless specification.
...
## Usage
```
/Task:31-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加 Twilio 配置结构"

```
Use the @spec-task-executor agent to implement task 31: "添加 Twilio 配置结构" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: 添加 Twilio 配置结构
- Leverage: server/shared/src/config/mod.rs
- Requirements: 2.9

## Instructions
- Implement ONLY task 31: "添加 Twilio 配置结构"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 31 --mode complete
```
