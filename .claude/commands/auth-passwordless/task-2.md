# auth-passwordless - Task 2

Execute task 2 for the auth-passwordless specification.

## Task Description
创建 refresh_tokens 表的数据库迁移脚本
...
## Usage
```
/Task:2-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 refresh_tokens 表的数据库迁移脚本"

```
Use the @spec-task-executor agent to implement task 2: "创建 refresh_tokens 表的数据库迁移脚本" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: 创建 refresh_tokens 表的数据库迁移脚本
- Leverage: server/migrations/001
- Requirements: 5.2, 5.5

## Instructions
- Implement ONLY task 2: "创建 refresh_tokens 表的数据库迁移脚本"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 2 --mode complete
```
