# auth-passwordless - Task 43

Execute task 43 for the auth-passwordless specification.

## Task Description
更新 API 文档

## Code Reuse
**Leverage existing code**: OpenAPI 格式
...
```
Use the @spec-task-executor agent to implement task 43: "更新 API 文档" for the auth-passwordless specification and include all the below context.
...
## Instructions
- Implement ONLY task 43: "更新 API 文档"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 43 --mode complete
```
