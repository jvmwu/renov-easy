# auth-passwordless - Task 6

Execute task 6 for the auth-passwordless specification.

## Task Description
实现速率限制服务

## Code Reuse
**Leverage existing code**: server/core/src/services/auth/rate
...
## Usage
```
/Task:6-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现速率限制服务"

```
Use the @spec-task-executor agent to implement task 6: "实现速率限制服务" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 实现速率限制服务
- Leverage: server/core/src/services/auth/rate
- Requirements: 3.1, 3.3, 3.8

## Instructions
- Implement ONLY task 6: "实现速率限制服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 6 --mode complete
```
