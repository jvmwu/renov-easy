# auth-passwordless - Task 42

Execute task 42 for the auth-passwordless specification.

## Task Description
创建数据库迁移运行脚本

## Code Reuse
**Leverage existing code**: sqlx migrate
...
## Usage
```
/Task:42-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建数据库迁移运行脚本"

```
Use the @spec-task-executor agent to implement task 42: "创建数据库迁移运行脚本" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 42
- Description: 创建数据库迁移运行脚本
- Leverage: sqlx migrate
- Requirements: 数据库准备

## Instructions
- Implement ONLY task 42: "创建数据库迁移运行脚本"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 42 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 42 --mode complete
```
