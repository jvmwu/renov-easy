# auth-passwordless - Task 28

Execute task 28 for the auth-passwordless specification.

## Task Description
增强速率限制中间件

## Code Reuse
**Leverage existing code**: 现有中间件结构, rate
...
## Usage
```
/Task:28-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "增强速率限制中间件"

```
Use the @spec-task-executor agent to implement task 28: "增强速率限制中间件" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: 增强速率限制中间件
- Leverage: 现有中间件结构, rate
- Requirements: 3.1, 3.3

## Instructions
- Implement ONLY task 28: "增强速率限制中间件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 28 --mode complete
```
