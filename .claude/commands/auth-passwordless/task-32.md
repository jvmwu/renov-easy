# auth-passwordless - Task 32

Execute task 32 for the auth-passwordless specification.

## Task Description
添加 AWS SNS 配置结构

## Code Reuse
**Leverage existing code**: server/shared/src/config/mod.rs
...
## Usage
```
/Task:32-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加 AWS SNS 配置结构"

```
Use the @spec-task-executor agent to implement task 32: "添加 AWS SNS 配置结构" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: 添加 AWS SNS 配置结构
- Leverage: server/shared/src/config/mod.rs
- Requirements: 2.10

## Instructions
- Implement ONLY task 32: "添加 AWS SNS 配置结构"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 32 --mode complete
```
