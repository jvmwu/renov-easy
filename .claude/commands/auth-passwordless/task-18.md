# auth-passwordless - Task 18

Execute task 18 for the auth-passwordless specification.

## Task Description
实现刷新令牌存储逻辑

## Code Reuse
**Leverage existing code**: 现有 TokenRepository trait
...
## Usage
```
/Task:18-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现刷新令牌存储逻辑"

```
Use the @spec-task-executor agent to implement task 18: "实现刷新令牌存储逻辑" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: 实现刷新令牌存储逻辑
- Leverage: 现有 TokenRepository trait
- Requirements: 5.5

## Instructions
- Implement ONLY task 18: "实现刷新令牌存储逻辑"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 18 --mode complete
```
