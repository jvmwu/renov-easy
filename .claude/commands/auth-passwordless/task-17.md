# auth-passwordless - Task 17

Execute task 17 for the auth-passwordless specification.

## Task Description
增强 TokenService 令牌生成

## Code Reuse
**Leverage existing code**: 现有 TokenService 结构
...
## Usage
```
/Task:17-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "增强 TokenService 令牌生成"

```
Use the @spec-task-executor agent to implement task 17: "增强 TokenService 令牌生成" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: 增强 TokenService 令牌生成
- Leverage: 现有 TokenService 结构
- Requirements: 5.3, 5.4

## Instructions
- Implement ONLY task 17: "增强 TokenService 令牌生成"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 17 --mode complete
```
