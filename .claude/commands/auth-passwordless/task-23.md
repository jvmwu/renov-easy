# auth-passwordless - Task 23

Execute task 23 for the auth-passwordless specification.

## Task Description
实现延迟响应机制

## Code Reuse
**Leverage existing code**: 速率限制服务
...
## Usage
```
/Task:23-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现延迟响应机制"

```
Use the @spec-task-executor agent to implement task 23: "实现延迟响应机制" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: 实现延迟响应机制
- Leverage: 速率限制服务
- Requirements: 6.1

## Instructions
- Implement ONLY task 23: "实现延迟响应机制"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 23 --mode complete
```
