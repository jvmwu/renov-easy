# auth-passwordless - Task 36

Execute task 36 for the auth-passwordless specification.

## Task Description
创建验证码验证集成测试

## Code Reuse
**Leverage existing code**: 测试工具函数
...
## Usage
```
/Task:36-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建验证码验证集成测试"

```
Use the @spec-task-executor agent to implement task 36: "创建验证码验证集成测试" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: 创建验证码验证集成测试
- Leverage: 测试工具函数
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 36: "创建验证码验证集成测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 36 --mode complete
```
