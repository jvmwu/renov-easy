# auth-passwordless - Task 9

Execute task 9 for the auth-passwordless specification.

## Task Description
实现 SMS 服务故障转移管理器

## Code Reuse
**Leverage existing code**: twilio
...
## Usage
```
/Task:9-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现 SMS 服务故障转移管理器"

```
Use the @spec-task-executor agent to implement task 9: "实现 SMS 服务故障转移管理器" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 9
- Description: 实现 SMS 服务故障转移管理器
- Leverage: twilio
- Requirements: 2.10

## Instructions
- Implement ONLY task 9: "实现 SMS 服务故障转移管理器"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 9 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 9 --mode complete
```
