# auth-passwordless - Task 24

Execute task 24 for the auth-passwordless specification.

## Task Description
添加分布式攻击检测

## Code Reuse
**Leverage existing code**: 审计日志数据
...
## Usage
```
/Task:24-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加分布式攻击检测"

```
Use the @spec-task-executor agent to implement task 24: "添加分布式攻击检测" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: 添加分布式攻击检测
- Leverage: 审计日志数据
- Requirements: 6.4, 6.5

## Instructions
- Implement ONLY task 24: "添加分布式攻击检测"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 24 --mode complete
```
