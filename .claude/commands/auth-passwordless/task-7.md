# auth-passwordless - Task 7

Execute task 7 for the auth-passwordless specification.
...
## Usage
```
/Task:7-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现 Twilio SMS 服务提供商"

```
Use the @spec-task-executor agent to implement task 7: "实现 Twilio SMS 服务提供商" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: 实现 Twilio SMS 服务提供商
- Leverage: server/core/src/services/verification/traits.rs
- Requirements: 2.9

## Instructions
- Implement ONLY task 7: "实现 Twilio SMS 服务提供商"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 7 --mode complete
```
