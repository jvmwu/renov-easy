# auth-passwordless - Task 27

Execute task 27 for the auth-passwordless specification.

## Task Description
实现错误响应标准化

## Code Reuse
**Leverage existing code**: 现有错误处理框架
...
## Usage
```
/Task:27-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现错误响应标准化"

```
Use the @spec-task-executor agent to implement task 27: "实现错误响应标准化" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: 实现错误响应标准化
- Leverage: 现有错误处理框架
- Requirements: 2.7

## Instructions
- Implement ONLY task 27: "实现错误响应标准化"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 27 --mode complete
```
