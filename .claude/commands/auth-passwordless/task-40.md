# auth-passwordless - Task 40

Execute task 40 for the auth-passwordless specification.

## Task Description
实现健康检查端点

## Code Reuse
**Leverage existing code**: 现有健康检查框架
...
## Usage
```
/Task:40-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现健康检查端点"

```
Use the @spec-task-executor agent to implement task 40: "实现健康检查端点" for the auth-passwordless specification and include all the below context.
...
## Instructions
- Implement ONLY task 40: "实现健康检查端点"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 40 --mode complete
```
