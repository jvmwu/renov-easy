# auth-passwordless - Task 37

Execute task 37 for the auth-passwordless specification.

## Task Description
创建 JWT 令牌服务单元测试

## Code Reuse
**Leverage existing code**: MockTokenRepository
...
## Usage
```
/Task:37-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 JWT 令牌服务单元测试"

```
Use the @spec-task-executor agent to implement task 37: "创建 JWT 令牌服务单元测试" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: 创建 JWT 令牌服务单元测试
- Leverage: MockTokenRepository
- Requirements: 5.1, 5.7

## Instructions
- Implement ONLY task 37: "创建 JWT 令牌服务单元测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 37 --mode complete
```
