# auth-passwordless - Task 10

Execute task 10 for the auth-passwordless specification.

## Task Description
增强 VerificationService 的 OTP 生成逻辑

## Code Reuse
**Leverage existing code**: 现有 VerificationService 结构
...
## Usage
```
/Task:10-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "增强 VerificationService 的 OTP 生成逻辑"

```
Use the @spec-task-executor agent to implement task 10: "增强 VerificationService 的 OTP 生成逻辑" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: 增强 VerificationService 的 OTP 生成逻辑
- Leverage: 现有 VerificationService 结构
- Requirements: 2.1

## Instructions
- Implement ONLY task 10: "增强 VerificationService 的 OTP 生成逻辑"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 10 --mode complete
```
