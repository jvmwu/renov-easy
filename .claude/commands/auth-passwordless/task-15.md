# auth-passwordless - Task 15

Execute task 15 for the auth-passwordless specification.

## Task Description
增强 AuthService 的速率限制集成

## Code Reuse
**Leverage existing code**: 现有 AuthService, rate
...
## Usage
```
/Task:15-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "增强 AuthService 的速率限制集成"

```
Use the @spec-task-executor agent to implement task 15: "增强 AuthService 的速率限制集成" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: 增强 AuthService 的速率限制集成
- Leverage: 现有 AuthService, rate
- Requirements: 3.1, 3.2

## Instructions
- Implement ONLY task 15: "增强 AuthService 的速率限制集成"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 15 --mode complete
```
