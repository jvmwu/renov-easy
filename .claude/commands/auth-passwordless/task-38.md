# auth-passwordless - Task 38

Execute task 38 for the auth-passwordless specification.

## Task Description
创建认证 API 端点集成测试

## Code Reuse
**Leverage existing code**: actix-web test helpers
...
## Usage
```
/Task:38-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建认证 API 端点集成测试"

```
Use the @spec-task-executor agent to implement task 38: "创建认证 API 端点集成测试" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: 创建认证 API 端点集成测试
- Leverage: actix-web test helpers
- Requirements: 1.3, 2.1

## Instructions
- Implement ONLY task 38: "创建认证 API 端点集成测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 38 --mode complete
```
