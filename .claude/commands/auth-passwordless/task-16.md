# auth-passwordless - Task 16

Execute task 16 for the auth-passwordless specification.

## Task Description
配置 JWT RS256 密钥对

## Code Reuse
**Leverage existing code**: jsonwebtoken crate
...
## Usage
```
/Task:16-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "配置 JWT RS256 密钥对"

```
Use the @spec-task-executor agent to implement task 16: "配置 JWT RS256 密钥对" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: 配置 JWT RS256 密钥对
- Leverage: jsonwebtoken crate
- Requirements: 5.3

## Instructions
- Implement ONLY task 16: "配置 JWT RS256 密钥对"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 16 --mode complete
```
