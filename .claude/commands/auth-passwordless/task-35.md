# auth-passwordless - Task 35

Execute task 35 for the auth-passwordless specification.

## Task Description
创建速率限制服务单元测试

## Code Reuse
**Leverage existing code**: MockCacheService
...
## Usage
```
/Task:35-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建速率限制服务单元测试"

```
Use the @spec-task-executor agent to implement task 35: "创建速率限制服务单元测试" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 35
- Description: 创建速率限制服务单元测试
- Leverage: MockCacheService
- Requirements: 3.1

## Instructions
- Implement ONLY task 35: "创建速率限制服务单元测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 35 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 35 --mode complete
```
