# auth-passwordless - Task 11

Execute task 11 for the auth-passwordless specification.

## Task Description
实现验证码 Redis 存储逻辑

## Code Reuse
**Leverage existing code**: 现有 verification

## Requirements Reference
**Requirements**: 2.11, 4.7, 8.2

## Usage
```
/Task:11-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现验证码 Redis 存储逻辑"

```
Use the @spec-task-executor agent to implement task 11: "实现验证码 Redis 存储逻辑" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: 实现验证码 Redis 存储逻辑
- Leverage: 现有 verification
- Requirements: 2.11, 4.7, 8.2

## Instructions
- Implement ONLY task 11: "实现验证码 Redis 存储逻辑"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 11 --mode complete
```
