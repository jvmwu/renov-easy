# auth-passwordless - Task 1

Execute task 1 for the auth-passwordless specification.

## Task Description
创建 verification_codes 表的数据库迁移脚本

## Code Reuse
**Leverage existing code**: server/migrations/001
...
## Usage
```
/Task:1-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建 verification_codes 表的数据库迁移脚本"

```
Use the @spec-task-executor agent to implement task 1: "创建 verification_codes 表的数据库迁移脚本" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: 创建 verification_codes 表的数据库迁移脚本
- Leverage: server/migrations/001
- Requirements: 2.1, 4.1, 8.1

## Instructions
- Implement ONLY task 1: "创建 verification_codes 表的数据库迁移脚本"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 1 --mode complete
```
