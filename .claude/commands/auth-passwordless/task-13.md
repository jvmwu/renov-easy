# auth-passwordless - Task 13

Execute task 13 for the auth-passwordless specification.

## Task Description
实现发送验证码 API 处理器

## Code Reuse
**Leverage existing code**: 现有路由结构, DTOValidation
...
## Usage
```
/Task:13-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现发送验证码 API 处理器"

```
Use the @spec-task-executor agent to implement task 13: "实现发送验证码 API 处理器" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: 实现发送验证码 API 处理器
- Leverage: 现有路由结构, DTOValidation
- Requirements: 1.3

## Instructions
- Implement ONLY task 13: "实现发送验证码 API 处理器"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 13 --mode complete
```
