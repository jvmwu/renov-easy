# auth-passwordless - Task 33

Execute task 33 for the auth-passwordless specification.

## Task Description
更新应用配置聚合

## Code Reuse
**Leverage existing code**: 现有配置结构
...
## Usage
```
/Task:33-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "更新应用配置聚合"

```
Use the @spec-task-executor agent to implement task 33: "更新应用配置聚合" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: 更新应用配置聚合
- Leverage: 现有配置结构
- Requirements: 4.1

## Instructions
- Implement ONLY task 33: "更新应用配置聚合"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 33 --mode complete
```
