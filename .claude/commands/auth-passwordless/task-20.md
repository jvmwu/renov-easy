# auth-passwordless - Task 20

Execute task 20 for the auth-passwordless specification.

## Task Description
实现审计日志仓储

## Code Reuse
**Leverage existing code**: server/core/src/repositories/audit/trait.rs
...
## Usage
```
/Task:20-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现审计日志仓储"

```
Use the @spec-task-executor agent to implement task 20: "实现审计日志仓储" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: 实现审计日志仓储
- Leverage: server/core/src/repositories/audit/trait.rs
- Requirements: 7.1, 7.8

## Instructions
- Implement ONLY task 20: "实现审计日志仓储"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 20 --mode complete
```
