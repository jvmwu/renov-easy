# auth-passwordless - Task 12

Execute task 12 for the auth-passwordless specification.

## Task Description
实现验证码验证和尝试管理

## Code Reuse
**Leverage existing code**: verification
...
## Usage
```
/Task:12-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现验证码验证和尝试管理"

```
Use the @spec-task-executor agent to implement task 12: "实现验证码验证和尝试管理" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: 实现验证码验证和尝试管理
- Leverage: verification
- Requirements: 2.3, 2.4, 6.2

## Instructions
- Implement ONLY task 12: "实现验证码验证和尝试管理"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 12 --mode complete
```
