# auth-passwordless - Task 25

Execute task 25 for the auth-passwordless specification.

## Task Description
创建认证错误消息的中文翻译

## Code Reuse
**Leverage existing code**: 现有 i18n 系统
...
## Usage
```
/Task:25-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建认证错误消息的中文翻译"

```
Use the @spec-task-executor agent to implement task 25: "创建认证错误消息的中文翻译" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: 创建认证错误消息的中文翻译
- Leverage: 现有 i18n 系统
- Requirements: 1.2

## Instructions
- Implement ONLY task 25: "创建认证错误消息的中文翻译"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 25 --mode complete
```
