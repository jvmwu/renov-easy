# auth-passwordless - Task 26

Execute task 26 for the auth-passwordless specification.
...
## Usage
```
/Task:26-auth-passwordless
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建认证错误消息的英文翻译"

```
Use the @spec-task-executor agent to implement task 26: "创建认证错误消息的英文翻译" for the auth-passwordless specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: 创建认证错误消息的英文翻译
- Leverage: 现有 i18n 系统
- Requirements: 1.2

## Instructions
- Implement ONLY task 26: "创建认证错误消息的英文翻译"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks auth-passwordless 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks auth-passwordless 26 --mode complete
```
